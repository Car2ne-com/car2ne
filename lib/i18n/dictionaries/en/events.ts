...
export const events: (typeof it)["events"] = {
  ...
  rides: {
    ...
    sectionOutbound: "🚗 Outbound — to the event",
    sectionReturn: "🔁 Return — from the event",
    ...
    directionBadgeOutbound: "Outbound",
    directionBadgeReturn: "Return",
    ...
    returnTeaserTitle: "Need the return trip too?",
    returnTeaserCta: "Also request the return",
    returnTeaserSending: "Sending request...",
    returnTeaserSent: "Return request sent",
    returnTeaserConfirmed: "Return confirmed",
    returnTeaserMultipleText:
      "There are {count} return rides available for this event.",
    returnTeaserSeeAll: "See the return rides →",
  },
};
