...
export default async function CTA() {
  ...
  return (
    <section className="px-6 py-20">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] bg-emerald-950 px-8 py-20 text-center sm:px-16">
        ...
        <div className="relative pt-12">
          <h2 className="font-display text-4xl font-medium tracking-[-0.02em] text-white sm:text-5xl">
            {t.title}
          </h2>
